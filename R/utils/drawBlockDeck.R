drawBlockDeck = function( BlockDeckData, title="" )  {
  quartz()
  numBlocks = dim(BlockDeckData)[1]
  ...
  for (i in 1:4)  {
    ...
    if (i ==1) {
      plot(1:numBlocks,BlockDeckData[,i],ylim=c(0,0.5), type="b"
      ...
      lines(1:numBlocks,BlockDeckData[,i],ylim=c(0,0.5), type="b"
