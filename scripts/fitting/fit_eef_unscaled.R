#!/usr/bin/env Rscript
# =============================================================================
# FIT EEF MODEL - UNSCALED VERSION (JAGS)
# =============================================================================
# Fits the Exploitation-Exploration with Forgetting model (Yang et al. 2025)
# WITHOUT scaling outcomes - uses original monetary values
...
#
# Usage: Rscript fit_eef_unscaled.R [HC|Amph|Hero]
# =============================================================================
...
cat("\n================================================\n")
cat("PROCESSING GROUP:", target_group, "(", study_label, ") - UNSCALED\n")
cat("================================================\n")
...
# NO SCALING - keep original monetary values
cat("Using UNSCALED outcomes (original monetary values)...\n")

# JAGS Fitting
output_dir <- "outputs/parameter_estimation/eef_unscaled"
...
cat("Fitting hierarchical EEF model (UNSCALED) for group:", target_group, "...\n")
...
# Save Results
save_path <- file.path(output_dir, paste0("eef_unscaled_fit_", target_group, ".rds"))
