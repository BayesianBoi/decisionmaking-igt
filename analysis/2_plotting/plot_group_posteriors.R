...
output_dir <- "analysis/plots/group_comparison"
...
orl_files <- list(
    HC = "analysis/outputs/orl/orl_fit_HC.rds",
    Amph = "analysis/outputs/orl/orl_fit_Amph.rds",
    Hero = "analysis/outputs/orl/orl_fit_Hero.rds"
)
...
eef_files <- list(
    HC = "analysis/outputs/eef/eef_fit_HC.rds",
    Amph = "analysis/outputs/eef/eef_fit_Amph.rds",
    Hero = "analysis/outputs/eef/eef_fit_Hero.rds"
)
