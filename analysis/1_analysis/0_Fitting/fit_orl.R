#!/usr/bin/env Rscript
# ==============================================================================
# FIT ORL MODEL (JAGS) - Class Script Adaptation
# ==============================================================================
# Adaptation of: temp/inspiration/parameter_estimation/hier_ORL_healthy_scaled.R
#
# Purpose:
#   Fits the ORL model to IGT data using JAGS.
#   Fits a SINGLE specified group via Command Line Argument.
#   SCALES outcomes by 100.
...
# 4. JAGS Fitting
# ------------------------------------------------------------------------------
output_dir <- "analysis/outputs/orl"
dir.create(output_dir, recursive = TRUE, showWarnings = FALSE)

model_file <- "analysis/models/orl.txt"
